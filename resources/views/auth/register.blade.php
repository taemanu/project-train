            ...
            <div class="card text-white bg-dark">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="first_name" class="col-md-4 col-form-label text-md-end">{{ __('ชื่อ') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="address" class="col-md-4 col-form-label text-md-end">{{ __('ที่อยู่') }}</label>

                            <div class="col-md-6">
                                <textarea name="address" id="address" cols="30" rows="5"class="form-control @error('address') is-invalid @enderror" value="{{ old('address') }}" required autocomplete="address" autofocus></textarea>
